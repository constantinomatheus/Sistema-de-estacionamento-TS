(function () {
    ...
    function clientes() {
        function adicionarCliente(cliente) {
            ...
            `;
            (_a = $("#clientes")) === null || _a === void 0 ? void 0 : _a.appendChild(rowCliente);
        }
...
(function () {
    ...
    function patio() {
        ...
        function adicionar(veiculo, vaiSalvar) {
            var _a, _b;
    ...
    patio().render();
    (_a = $("#cadastrarVeiculo")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        var _a, _b;
